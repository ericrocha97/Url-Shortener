...
import { StyleSheet, Text, View, TextInput, Clipboard, TouchableOpacity, Keyboard, TouchableWithoutFeedback, Alert, KeyboardAvoidingView, Platform } from 'react-native';
